<div class="col-md-12 col-lg-6 article-col">
    <div class="card article-card">
        ...
        <ul class="list-group list-group-flush card-list-group">
            ...
            <li class="list-group-item article-category"><a href="{{route('pm.series.post', [$post->series->slug, $post->slug])}}"><ion-icon name="albums"></ion-icon> {{$post->series->name}} <span class="badge badge-pill badge-dark">Series</span></a></li>
            @else 

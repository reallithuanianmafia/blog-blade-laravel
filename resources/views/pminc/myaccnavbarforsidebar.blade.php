<div class="col-md-4 playlist">
    <div class="list-group">
        <a class="list-group-item list-group-item-action text-center">Navigation</a>
            ...
            <a href="{{route('pm.myaccount.savedposts.index')}}" class="list-group-item list-group-item-action {{ Route::is('pm.myaccount.savedposts') ? 'active btn-dark' : '' }}">Saved Posts</a>
            <a href="{{route('pm.myaccount.index')}}" class="list-group-item list-group-item-action {{ Route::is('pm.myaccount.savedposts') ? 'active btn-dark' : '' }}">Saved Posts</a>
